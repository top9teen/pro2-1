...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
  ...
  <a href="rentmember.html" class="w3-bar-item w3-button w3-padding-24" style="font-size: 20px; font-family: cursive;">ข้อมูลการเช่าภาชนะ</a>
...
<div class="w3-teal">
  ...
  <div class="w3-container">
    <h1 align="center">ระบบจัดการฐานข้อมูลศูนย์อาหารมหาวิทยาลัยราชภัฏบุรีรัมย์</h1>
  </div>
</div>
