...
INSERT INTO `container` (`C_ID`, `C_Name`, `C_Price`, `Number`) VALUES
	('CB001', 'ชาม', 2, 4809),
	('CC001', 'ถ้วยน้ำซุป', 2, 2197),
	('CC002', 'ถ้วยน้ำจิ้ม', 2, 2600),
	('CD001', 'จาน', 2, 3000);
...
CREATE TABLE IF NOT EXISTS `detailrent` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 COMMENT='ข้อมูลรายละเอียดการเช่า';

-- Dumping data for table projec.detailrent: ~13 rows (approximately)
...
INSERT INTO `detailrent` (`ID`, `ID_Card`, `CB001`, `CC001`, `CC002`, `CD001`, `Number`, `dateday`, `datemont`, `dateyear`, `alloder`, `status`) VALUES
	...
	(19, 'bb', 5, 5, 5, 5, 40, 14, 0, 2561, NULL, '1'),
...
-- Dumping data for table projec.user: ~5 rows (approximately)
